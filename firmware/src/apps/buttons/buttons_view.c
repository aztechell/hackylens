...
static void buttons_view_draw_row(uint16_t y, const char *name, uint32_t mask, uint32_t state)
{
    ...
    hk_ui_display_fill_rect(12, y, HK_DISPLAY_REQUIRED_WIDTH - 24, HACKYLENS_FONT_H, COLOR_BLACK);
    hk_ui_display_draw_text_at(12, y, line, COLOR_TERM_GREEN, COLOR_BLACK);
}
