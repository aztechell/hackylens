...
_Static_assert(sizeof(settings_payload_t) == 106U, "settings v5 payload layout changed");
_Static_assert(sizeof(settings_record_t) == 124U, "settings v5 record layout changed");
